...
export default function CheckoutPage() {
  ...
  const product = productId
    ? allProducts.find((p) => String(p.id) === productId)
    : undefined;
    ...
    <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 text-white p-6 flex flex-col md:flex-row gap-8">
      ...
      <div className="flex-1 bg-gray-900 p-6 rounded-lg shadow-md">
        ...
        <div className="space-y-3">
          ...
          <input
            ...
            onChange={(e) => setUserDetails({ ...userDetails, locality: e.target.value })}
          />
          <textarea
            placeholder="Address (House No, Area)"
            className="w-full p-2 rounded bg-gray-800"
          ...
          <div className="flex gap-4 mt-2 text-sm">
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={() => setUserDetails({ ...userDetails, addressType: "Home" })}
              />
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={() => setUserDetails({ ...userDetails, addressType: "Work" })}
              />
      ...
      {addressSaved && (
        <div className="flex-1 bg-gray-900 p-6 rounded-lg shadow-md">
          ...
          <button
            className="mt-6 w-full bg-green-600 py-2 rounded hover:bg-green-700"
